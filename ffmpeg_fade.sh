...
#----------------------------------------------------------------
# SETTINGS
input_dir="/home/xyy/matcode/covid/pic_v"  # Replace this by a path to your folder /path/to/your/folder
n_files=74                        # Replace this by a number of images
...
crossfade="(1/2)"                     # Crossfade duration between two images
#----------------------------------------------------------------
